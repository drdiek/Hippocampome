function neurites()
    ...
    for iNeuron = 1:nNeurons 
        percentOfPresenceAxons(iNeuron,:) = percentOfPresenceAxons(iNeuron,nParcels:-1:1);
        percentOfPresenceDendrites(iNeuron,:) = percentOfPresenceDendrites(iNeuron,nParcels:-1:1);
    end % iNeuron
