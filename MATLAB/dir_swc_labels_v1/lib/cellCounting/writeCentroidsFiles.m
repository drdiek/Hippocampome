...
%
% Usage 
% writeCentroidsFiles(cleanupDirectory, stitchedImageDirectory, fileName, doDetectCircles, doWriteCentroidImage, minAreaSize, maxAreaSize, nThreads)
% 
% History
% Author   | Date         |Change
%==========|==============|=================================================
...
%--------------------------------------------------------------------------
function writeCentroidsFiles(cleanupDirectory, stitchedImageDirectory, fileName, doDetectCircles, doWriteCentroidImage, minAreaSize, maxAreaSize, xSpacing, ySpacing, zSpacing, nThreads, labelFileName)
...
cleanupDirectory = validateDirectory (cleanupDirectory);
stitchedImageDirectory = validateDirectory (stitchedImageDirectory);
...
parfor iFile = 1:length(listOfFiles)
  ...
  if (isCleanedUpFile)
    ...
    imCleanup = removeSmallRegions ((imCleanup > 0), minAreaSize-1, maxAreaSize);
