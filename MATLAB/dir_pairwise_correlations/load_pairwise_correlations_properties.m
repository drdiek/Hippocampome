function [pairCorrProperties, typeIds, nTypeIds, typeNames, propertyNames] = load_pairwise_correlations_properties()
...
% pairCorrProperties = randi([0,1], nTypeIds, nProperties);

for i = 1:nTypeIds
    
    for j = 1:nProperties
        
        pairCorrProperties(i,j) = type_property_matrix{i+1,j+1};
