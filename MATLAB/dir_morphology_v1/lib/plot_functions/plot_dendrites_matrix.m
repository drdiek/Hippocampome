function plot_dendrites_matrix(csvFile)
...
%                     end% if ~isempty(csvFile{axonRow,P})
    ...
    if isJanelia
        ...
        text(-3, nOfficialParcellations+9.5,  'Dendritic Locations', ...
...
%     end % if isIncludeFlaggedDuplicates
    ...
    if (isunix)
        delete 'Cij_dendrites.eps';
        print(gcf, '-depsc', '-r800', './Cij_dendrites.eps'); 
    end
