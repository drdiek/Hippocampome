function morphologySWCWriter(swcStructureArray, swcFileName, header, labelImageFile)
...
% modified by Diek W. Wheeler 08/02/2018
  ...
  fprintf(swcFilePtr, '# interpreted with %s\n', labelImageFile(8:end));
...
%     swcArray = [pointID' pointLabel' xCoord' yCoord' zCoord' radius' parentID' pointAcronym' pointName' pointColor'];
    ...
    for iColor = 1:nPointColorUnique
        ...
        strng = sprintf('# %d = %s:', iColor-1, pointColors{mod(iColor-1, 16)+1});
