function plot_Cij_matrix_unix(CijFilledPercentage)
    ...
    for i = 1:N
        for j = 1:N
            if (CijKnownNegClassLinks(i,j) ~= 0)
                ...
                if CijSpecialConnections(i,j) ~= 0
    ...
    axis off
    hold on
    figureAxis = [-0 (N+0)*10 -0 (N+0)*10];%[-100 (N+1)*10 -120 (N+20)*10];
    axis(figureAxis)
    ...
    for i = 1:N       
        ...
        %text(-5, (i-1)*10+5, abbrev_code_cat, 'HorizontalAlignment', 'right', 'FontSize', font_size, 'Interpreter', 'none')
    ...
    % was -90
    text(-120, 10*DGstart, 'DG', 'HorizontalAlignment', 'center', 'rotation', 90, 'FontSize', 5);
    text(-120, 10*CA3start, 'CA3', 'HorizontalAlignment', 'center', 'rotation', 90, 'FontSize', 5);
    text(-120, 10*CA2start, 'CA2', 'HorizontalAlignment', 'center', 'rotation', 90, 'FontSize', 5);
    text(-120, 10*CA1start, 'CA1', 'HorizontalAlignment', 'center', 'rotation', 90, 'FontSize', 5);
    text(-120, 10*SUBstart, 'SUB', 'HorizontalAlignment', 'center', 'rotation', 90, 'FontSize', 5);
    text(-120, 10*ECstart, 'EC', 'HorizontalAlignment', 'center', 'rotation', 90, 'FontSize', 5);

    text(10*DGstart, -120, 'DG', 'HorizontalAlignment', 'center', 'FontSize', 5);
    text(10*CA3start, -120, 'CA3', 'HorizontalAlignment', 'center', 'FontSize', 5);
    text(10*CA2start, -120, 'CA2', 'HorizontalAlignment', 'center', 'FontSize', 5);
    text(10*CA1start, -120, 'CA1', 'HorizontalAlignment', 'center', 'FontSize', 5);
    text(10*SUBstart, -120, 'SUB', 'HorizontalAlignment', 'center', 'FontSize', 5);
    text(10*ECstart, -120, 'EC', 'HorizontalAlignment', 'center', 'FontSize', 5);
    ...
    text(-80, 10*(N+7), strng, 'HorizontalAlignment', 'left', 'FontName', 'Times', ...
    	'Fontsize', 6, 'Color', 'k');
    ...
    %    delete 'Cij_plot.eps';
    orient(gcf, 'tall');
    print(gcf, '-depsc', '-r800', 'Cij_plot.eps');
