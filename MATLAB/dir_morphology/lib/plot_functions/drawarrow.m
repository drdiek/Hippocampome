function drawarrow(x1,x2,y1,y2,len, arrowFillColor, arrowEdgeColor)
...
cita=pi/18; % default angle between the two sides of arrow is 30
cos_cita=cos(cita);
sin_cita=sin(cita);
...
hdl_line=line(x,y,'color',arrowFillColor); % you can change the color of line here,default color is black
p1_x=x2;
p1_y=y2;
...
hdl_head=fill([p1_x p2_x p3_x], [p1_y p2_y p3_y], arrowFillColor, 'edgecolor', arrowEdgeColor); % you can change the color of arrow here,default color is black
