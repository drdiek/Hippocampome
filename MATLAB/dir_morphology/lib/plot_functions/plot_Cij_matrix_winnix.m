function plot_Cij_matrix_winnix(CijFilledPercentage)
    ...
    for i = 1:N       
        ...
        text((i-1)*10+5, -5, abbrev_code_cat, 'rotation', 90, 'FontSize', 5, 'Interpreter', 'none')
        text(-5, (i-1)*10+5, abbrev_code_cat, 'HorizontalAlignment', 'right', 'FontSize', 5, 'Interpreter', 'none')
    end % i loop
    ...
    text(-90, -85, strng, 'HorizontalAlignment', 'left', 'FontSize', 7);
    ...
    delete 'Cij_plot.tif';
    print(gcf, '-dtiff', '-r800', 'Cij_plot.tif');
    delete 'Cij_plot.eps';
    orient(gcf, 'tall');
