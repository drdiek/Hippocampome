function save_data_structure(dataStruct, brainRegion, cellType, nNeuronResources, nBrainRegions2Save, nCellTypes2Save)

    disp(' ');
    strng = sprintf('Writing %s:%s data structure to file ...', brainRegion, cellType);
    disp(strng);
